              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-offset-4 col-md-4">
                        <!-- <img class="logo" src="image/news.jpg" alt="logo" style="margin-left:84px;"> -->
                          ...
                          <?php
                            ...
                            //  $conn=mysqli_connect("localhost","root","","student")or die("Connection failed : " . mysqli_connect_error());
                              if(empty($_POST['username']) || empty($_POST['password'])){
                                ...
                                echo $user,$pass;
                                $sql = "SELECT id,username  FROM registration WHERE username = '{$user}' AND password='{$pass}'";
                             ...
                             $_SESSION['username']=$row['username'];
                                ...
                                header("Location: http://localhost/student/user.php");
                              }
